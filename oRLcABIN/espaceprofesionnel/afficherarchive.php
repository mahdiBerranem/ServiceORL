...
<div class="processus">
<label>processus :</label><strong><?= $listdosmed->processus;?></strong> <br>

</div>

<div class="trait">
<label>TRATEMENT SUBIS :</label><strong><?= $listdosmed->traitementSubis; ?></strong><br>
</div>
<hr>
<div class="num">
...
margin: 0 auto;
padding:10px;
background:rgba(0, 0, 0, 0.4) /*rgba(243, 110, 11, 0.9)*/;
left:20%;
border-radius: 5px;
}
.input-frm{
