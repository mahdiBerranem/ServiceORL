...
<head>
  <meta charset="utf-8"/>
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=yes"><!--important size ecran-->
...
<div class="frm">  
<div class="input-frm" >
<input type="text" id="nompat" name="nom" placeholder=" Nom " title="Le nom" required>
<input type="text" id="prenompat" name="prenom" placeholder=" Prénom " title="Le prenom" required>
<input type="date" id="daterdv" name="daterdv" placeholder="date de rend-vous" title="La date de Rendez-vous" required>
