...
<div class="frm">  
<div class="input-frm" >
<input type="text" id="nompat" name="nom" value="<?= $listrdv->nompat ?>" placeholder=" Nom " title="Le nom" required>
<input type="text" id="prenompat" name="prenom" value="<?= $listrdv->prenompat ?>" placeholder=" Prénom " title="Le prenom" required> 
<input type="date" id="daterdv" name="daterdv" value="<?= $listrdv->daterdv ?>" placeholder="date de rend-vous" title="La date de Rendez-vous" required>
</div> 
